    ...
    if plan["engine"] == "kova-core":
        rebuilt = build_core_plan(
            {"request_id": plan["request_id"],
             "messages": plan["operations"][0]["request_template"]["messages"][TRUSTED_SYSTEM_MESSAGE_COUNT:],
             **selection},
...
class ModelStageWorker:
    ...
    def __call__(self, spec, stage, artifacts, control, logical_id, attempt):
        ...
        candidates = [c for c in PINNED_CORE_CANDIDATES.values()
                      ...
                      and c["adapter_bundle_sha256"] == identity["adapter_bundle_sha256"]]
        ...
        require(serving["adapter_bundle_sha256"] == identity["adapter_bundle_sha256"],
                "worker adapter bundle differs from current candidate pin")
        ...
        try:
            if plan["engine"] == "kova-core":
                ...
                # The first Core stage has no artifact messages; its trusted
    ...
    def _ultra(self, plan, stage, artifacts, identity, candidate, client, records, logical_id, attempt):
        ...
        records.append({
            ...
            "adapter_bundle_sha256": before["loaded_adapter_bundle_sha256"],
